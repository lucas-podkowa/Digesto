                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a
                                    href="https://www.fio.unam.edu.ar/index.php?option=com_content&view=article&id=106&Itemid=558"
                                    class="text-gray-900 dark:text-white">Consejo Directivo</a></div>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <a class="nav-link" href="{{ route('digesto.index') }}"><i
                                        class="fas fa-folder-open"></i>Ver Digesto</a>
                            </div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Compilación ordenada de textos generados a partir de las sesiones llevadas a cabo por el
                                Consejo Directivo de la Facultad de Ingeniería - Universidad Nacional de Misiones
                            </div>
                        </div>
                    </div>
